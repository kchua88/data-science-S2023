...
-   Assuming your scopus is the probability of failure `POF` defined above, does your estimate exhibit real variability, induced variability, or both?
    -   Induced variability- we can have induced variability from df_samples due to there being limited strength data in the dataset which could influence our POF estimate.
