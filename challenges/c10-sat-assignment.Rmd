...
-   What is the confidence interval on the coefficient of `both_SAT`? Is
    ...
    -   The confidence interval on the coefficient of both_SAT is from
        0.001715376 to 0.003415381. The coefficient 0.002565378 is not
        much different from 0.
...
-   What is the confidence interval on the coefficient of `both_SAT`
    ...
    -    The confidence interval on the coefficient of both_SAT
        including high_GPA as a predictor is between 0.2989814792 to
        0.842138715. The coefficient of 0.5704600971 is significantly
        different from 0.
-   How do the hypothesis test results compare with the results in q6?
    -    The results from q7 show that high_GPA included as a predictor
        in univ_GPA is a better fit.
