...
-   How many aluminum alloys are in this dataset? How do you know?
    -   One alloy because all the aluminum alloys are listed as al_24st under the "alloy" column.
...
-   Does this graph support or contradict the claim above?
    -   This graph does not support the claim that E is an intensive property of the material. According to the graph, you can see that for each thickness of aluminum, data tends to cluster around a different Elastic modulus, notably for the 0.081 thickness, where the data clusters around the 10000 E value as compared to the other measurements clustering generally around the 10500 E value. Because E is supposed to be an intensive property of an Aluminum alloy, I wonder if this trend is due to a different alloy being used in mistake for the 0.081 thickness, or some error in measurements.
