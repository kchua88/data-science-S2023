...
-   The real data measurement looks like they are generally seeing more
    outliers and getting mean values outside of the 299900 to 300000
    range in the beginning (pre June 16) and getting more focused
    measurements within the range as time goes on. The simulated data
    measurement is the opposite: The initial measurements are more
    focused within the 299900 to 300000 range (starting after June 23)
    while later on the mean values deviate outside the range.
...
-   There may or may not be a correlation between Temp and Velocity
    Vacuum in Michaelson's dataset. If there was a correlation, this
    could explain the difference between Michaelson's estimate and
    Velocity Vacuum because the temperature variable of the test setup
    could have altered the Velocity of the light particles measured.
    However, the graph is inconclusive as the data points don't seem to
    follow a clear trend.
-   From the second graph it seems like we cannot conclude wheter
    Distinctness has an effect on the velocity vacuum measurement
    either. Looking at the box charts, there seems to be a weak positive
    trend happening between Distinctness and Velocity Vacuum, but there
    is too much overlap between the boxplots to draw a conclusion.
