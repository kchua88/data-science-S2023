...
-   Loving County occupies the top 10 slots for cases per 100k, and Mcmullen County occupies the top 10 slots for deaths per 100k. Both counties have vastly higher cases per 100k and deaths per 100k rates than the mean of each category. Both counties also have a very small population with only 102 people in Loving and 662 people in Mcmullen. It would make sense that since these counties have such small populations, if only a few people died or had Covid, the proportion of the population is so much higher than in other counties with thousands of people. For example, Mcmullen county had only 9 deaths but because the county is so small, the deaths_per100k value is very inflated.
